...
namespace Baidu.Netcore.UEditor
{
    ...
    public class CrawlerHandler : Handler
    {
        ...
        {
            var data = Request.Query.Where(u => u.Key == "source[]").Select(u => { return u.Value; }).ToList();
            ...
            Crawlers = data.Select(x => new Crawler(x, serverPath).Fetch()).ToArray();
    ...
    public class Crawler
    {
        ...
        public Crawler(string sourceUrl, string serverPath)
        {
        ...
        public Crawler Fetch()
        {
            ...
            using (var response = request.GetResponse() as HttpWebResponse)
            {
                ...
                var savePath = serverPath + "wwwroot\\" + ServerUrl;
